...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shiyongneirongCell  = document.createElement('td');

						  if(item.shiyongneirong != null && item.shiyongneirong != "" && item.shiyongneirong.length >= 11){
			  	shiyongneirongCell.innerHTML = item.shiyongneirong.substring(0, 10) + "..."; 
			  }else{
			  	shiyongneirongCell.innerHTML = item.shiyongneirong;
			  }


			row.appendChild(shiyongneirongCell);
