...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">老师申请管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>老师申请管理</span></li>
								<li class="breadcrumb-item active"><span>老师申请列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">老师申请列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shiyongxiangmuCell  = document.createElement('td');

						  if(item.shiyongxiangmu != null && item.shiyongxiangmu != "" && item.shiyongxiangmu.length >= 11){
			  	shiyongxiangmuCell.innerHTML = item.shiyongxiangmu.substring(0, 10) + "..."; 
			  }else{
			  	shiyongxiangmuCell.innerHTML = item.shiyongxiangmu;
			  }


			row.appendChild(shiyongxiangmuCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("laoshishenqing/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("laoshishenqing/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
	...
	function printTable() {
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("laoshishenqing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("laoshishenqing"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"laoshishenqing");
