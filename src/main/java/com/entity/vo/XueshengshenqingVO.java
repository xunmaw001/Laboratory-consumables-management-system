...
public class XueshengshenqingVO  implements Serializable {
	...
	public void setShiyongneirong(String shiyongneirong) {
		this.shiyongneirong = shiyongneirong;
	}
	
	/**
	 * 获取：使用内容
	 */
	public String getShiyongneirong() {
		return shiyongneirong;
	}
