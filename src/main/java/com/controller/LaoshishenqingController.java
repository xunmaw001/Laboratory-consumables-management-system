...
public class LaoshishenqingController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LaoshishenqingEntity laoshishenqing, HttpServletRequest request){
        EntityWrapper<LaoshishenqingEntity> ew = new EntityWrapper<LaoshishenqingEntity>();
    	PageUtils page = laoshishenqingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, laoshishenqing), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
    ...
    public R list( LaoshishenqingEntity laoshishenqing){
       	EntityWrapper<LaoshishenqingEntity> ew = new EntityWrapper<LaoshishenqingEntity>();
      	ew.allEq(MPUtil.allEQMapPre( laoshishenqing, "laoshishenqing")); 
        return R.ok().put("data", laoshishenqingService.selectListView(ew));
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<LaoshishenqingEntity> wrapper = new EntityWrapper<LaoshishenqingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = laoshishenqingService.selectCount(wrapper);
